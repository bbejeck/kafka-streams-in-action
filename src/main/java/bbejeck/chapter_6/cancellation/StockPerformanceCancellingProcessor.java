...
/**
 * Simple class demonstrating how to cancel a punctuation processing. In this case the punctuation
 * is stopped after 15 minutes.
 *
 * <p>This is a arbitrary example but demonstrates how we can cancel the punctuation. After
 * cancelling, you could reschedule for a different time or schedule a different Punctuator to run.
 */
public class StockPerformanceCancellingProcessor
  ...
  public void init(ProcessorContext processorContext) {
    ...
    StockPerformancePunctuator punctuator =
        new StockPerformancePunctuator(differentialThreshold, context(), keyValueStore);
