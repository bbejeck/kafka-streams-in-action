...
public class StockPerformanceStreamsAndProcessorMultipleValuesApplication {
  ...
  public static void main(String[] args) throws Exception {
    ...
    TransformerSupplier<
            String, StockTransaction, KeyValue<String, List<KeyValue<String, StockPerformance>>>>
        transformerSupplier =
            () ->
                new StockPerformanceMultipleValuesTransformer(
                    stocksStateStore, differentialThreshold);
