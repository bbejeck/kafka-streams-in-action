...
public class StockPerformanceMultipleValuesTransformerSupplier implements TransformerSupplier<String, StockTransaction, KeyValue<String, List<KeyValue<String, StockPerformance>>>> {

    private String stateStoreName;
    private double differentialThreshold;

    public StockPerformanceMultipleValuesTransformerSupplier(String stateStoreName, double differentialThreshold) {
    ...
    @Override
    public Transformer<String, StockTransaction, KeyValue<String, List<KeyValue<String, StockPerformance>>>> get() {
        return new StockPerformanceTransformer(stateStoreName, differentialThreshold);
    }

    private class StockPerformanceTransformer implements Transformer<String, StockTransaction, KeyValue<String, List<KeyValue<String, StockPerformance>>>> {
