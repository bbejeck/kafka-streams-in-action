...
public class PopsHopsApplication {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Deserializer<BeerPurchase> beerPurchaseDeserializer =
        new JsonDeserializer<>(BeerPurchase.class);
    ...
    String purchaseProcessorName = "purchase-processor";

    BeerPurchaseProcessor beerPurchaseProcessor =
    ...
    toplogy
        ...
        .addProcessor(purchaseProcessorName, () -> beerPurchaseProcessor, purchaseSourceNodeName);
    ...
    if (debugPrint) {
      // print events
      toplogy.addProcessor(
          domesticSalesSink, new KStreamPrinter("domestic-sales"), purchaseProcessorName);

      toplogy.addProcessor(
          internationalSalesSink, new KStreamPrinter("international-sales"), purchaseProcessorName);
    } else {
      // sink events to Kafka topics
      toplogy
          .addSink(
              internationalSalesSink, // unique sink name
              "international-sales",
              stringSerializer,
