...
public class StreamsSerdes {
  ...
  public static Serde<Tuple<List<ClickEvent>, List<StockTransaction>>>
      EventTransactionTupleSerde() {
  ...
  public static final class EventTransactionTupleSerde
      extends WrapperSerde<Tuple<List<ClickEvent>, List<StockTransaction>>> {
    private static final Type tupleType =
        new TypeToken<Tuple<List<ClickEvent>, List<StockTransaction>>>() {}.getType();
