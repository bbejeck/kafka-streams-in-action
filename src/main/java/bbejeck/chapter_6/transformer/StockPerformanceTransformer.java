...
// Schedule Punctuator in Transformer
public class StockPerformanceTransformer
    implements Transformer<String, StockTransaction, KeyValue<String, StockPerformance>> {
  ...
  public void init(ProcessorContext processorContext) {
    ...
    StockPerformancePunctuator punctuator =
        new StockPerformancePunctuator(differentialThreshold, processorContext, keyValueStore);
